...
public class SolrUtils {
    ...
    /**
     * Get system info from the remote Solr server.
     * 
    ...
    public static NamedList<Object> getSystemInfo() throws SophieException {
        ...
        try {
            return Sophie.client.request(request);
        } catch (SolrServerException | IOException | SolrException e) {
    ...
    /**
     * Get system properties from the remote Solr server.
     * 
    ...
    public static NamedList<Object> getSystemProperties() throws SophieException {
        QueryRequest request = new QueryRequest();
        request.setPath("/admin/properties");
        try {
            return Sophie.client.request(request);
        } catch (SolrServerException | IOException | SolrException e) {
